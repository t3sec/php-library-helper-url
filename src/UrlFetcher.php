...
class UrlFetcher {
	...
	protected $userAgent = 'php-library-helper-url/0.0.1 (+https://github.com/t3sec/php-library-helper-url))';
	...
	public function reset() {
		...
		$this->userAgent = 'php-library-helper-url/0.0.1 (+https://github.com/t3sec/php-library-helper-url)';
		return $this;
	}
}
